...
namespace roundhouse.migrators
{
    ...
    public sealed class DefaultDatabaseMigrator : DatabaseMigrator
    {
        ...
        public bool run_sql(string sql_to_run, string script_name, bool run_this_script_once, bool run_this_script_every_time, long version_id, Environment environment, string repository_version, string repository_path, ConnectionType connection_type, Queue<string> commands )
        {
                ...
                && this_script_should_run(script_name, sql_to_run, run_this_script_once, run_this_script_every_time))
            {
                ...
                if (!skip_run)
                {
                    ...
                    {
                        get_statements_to_run(sql_to_run).each(commands.Enqueue);
